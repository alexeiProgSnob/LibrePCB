...
AttrTypePower::AttrTypePower() noexcept
  ...
  mDefaultUnit = new AttributeUnit("watt", tr("W"));

  mAvailableUnits.append(new AttributeUnit("nanowatt", tr("nW")));
  mAvailableUnits.append(new AttributeUnit("microwatt", tr("μW")));
  mAvailableUnits.append(new AttributeUnit("milliwatt", tr("mW")));
  mAvailableUnits.append(mDefaultUnit);
  mAvailableUnits.append(new AttributeUnit("kilowatt", tr("kW")));
  mAvailableUnits.append(new AttributeUnit("megawatt", tr("MW")));
  mAvailableUnits.append(new AttributeUnit("gigawatt", tr("GW")));
}
